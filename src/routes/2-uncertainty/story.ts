...
export const pages: Page[] = [
	{
		text: 'Let’s start with an ordered state in which you know all nine particles are clumping together. Click on the squares to reveal where the particles are.',
